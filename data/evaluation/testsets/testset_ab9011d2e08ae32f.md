...
- **Generated At**: 2025-11-05T21:45:32.204034
- **RAGAS Version**: 0.3.1
- **Cache Key**: ab9011d2e08ae32f
...
- **Document Source**: `data/crawled/seoul_traffic/markdown_filtered`
- **Number of Documents**: 5
- **Target Language**: korean
- **Requested TestSet Size**: 2
...
- **JSON**: `testset_ab9011d2e08ae32f.json` (Complete data with metadata)
- **CSV**: `testset_ab9011d2e08ae32f.csv` (Tabular format)
- **Documentation**: `testset_ab9011d2e08ae32f.md` (This file)
