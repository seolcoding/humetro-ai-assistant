...
def main():
    ...
    generate_parser = subparsers.add_parser("generate", help="Generate corpus and QA datasets")
    generate_parser.add_argument("--chunk-size", type=int, default=512, help="Chunk size for document splitting")
    generate_parser.add_argument("--chunk-overlap", type=int, default=128, help="Chunk overlap for document splitting")
    generate_parser.add_argument("--num-samples", type=int, default=100, help="Number of QA samples to generate")
    generate_parser.add_argument("--questions-per-content", type=int, default=2, help="Number of questions per content")
    generate_parser.add_argument("--train-ratio", type=float, default=0.8, help="Ratio of training data")
    
    # Evaluate RAG command
    evaluate_parser = subparsers.add_parser("evaluate", help="Evaluate RAG pipeline")
    
    # Validate RAG command
    validate_parser = subparsers.add_parser("validate", help="Validate RAG pipeline configuration")
